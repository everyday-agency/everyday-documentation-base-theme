...
-   `test/scenarios/*.json` — individual scenario definitions
...
-   Medium: _Visual Regression Testing_ — high‑level overview and motivation.
-   BackstopJS Docs — scenarios, viewports, engine scripts, CI.

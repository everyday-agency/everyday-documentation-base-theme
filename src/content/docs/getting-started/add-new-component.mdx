...
[Clone the repository](https://github.com/everyday-agency/everyday-base-theme) and navigate to the `blocks/components` directory if you haven't already.
...
Now the block is registered. We must import now the new component into the allowed block to the container or the grid item.

...
<Aside type="note">
    The Swiper render logic has been updated. All Swiper render components
    should now use the `render_swiper_settings()` utility function for
    consistent data attribute output.
</Aside>
